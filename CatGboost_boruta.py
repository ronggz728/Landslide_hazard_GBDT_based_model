...
clf1 = CatBoostClassifier(logging_level='Verbose')
#分类器比较
...
exp_test.to_csv("F://fifth paper//OUTPUT//CB//CB_bor_test.csv")
print(probability_test)

probability_train = clf1.predict_proba(X_filtered_train)
exp_train = DataFrame(probability_train)
exp_train.to_csv("F://fifth paper//OUTPUT//CB//CB_bor_train.csv")
...
evaluate_method.get_ROC(y_test, predict_target,save_path='roc_stacking.png')
