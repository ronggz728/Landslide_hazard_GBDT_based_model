...
clf = LGBMClassifier(logging_level='Verbose')
...
dataset_1 = pd.read_csv('F://fifth paper//输出统计//screened//LightGBM//调序删表名版//input_1.csv', header=None, sep=',',
                        names=['fault', 'road', 'lithology', 'elevation', 'slope', 'NDVI', 'profile', 'plan',
                               'aspect', 'geological', 'rain', 'TRI', 'STI'])

x_columns_1 = [x for x in dataset_1.columns]
x_1 = dataset_1[x_columns_1]

dataset_2 = pd.read_csv('F://fifth paper//输出统计//screened//LightGBM//调序删表名版//input_2.csv', header=None, sep=',',
                        names=['fault', 'road', 'lithology', 'elevation', 'slope', 'NDVI', 'profile', 'plan',
                               'aspect', 'geological', 'rain', 'TRI', 'STI'])
...
dataset_3 = pd.read_csv('F://fifth paper//输出统计//screened//LightGBM//调序删表名版//input_3.csv', header=None, sep=',',
                        names=['fault', 'road', 'lithology', 'elevation', 'slope', 'NDVI', 'profile', 'plan',
                               'aspect', 'geological', 'rain', 'TRI', 'STI'])
...
dataset_4 = pd.read_csv('F://fifth paper//输出统计//screened//LightGBM//调序删表名版//input_4.csv', header=None, sep=',',
                        names=['fault', 'road', 'lithology', 'elevation', 'slope', 'NDVI', 'profile', 'plan',
                               'aspect', 'geological', 'rain', 'TRI', 'STI'])
...
dataset_5 = pd.read_csv('F://fifth paper//输出统计//screened//LightGBM//调序删表名版//input_5.csv', header=None, sep=',',
                        names=['fault', 'road', 'lithology', 'elevation', 'slope', 'NDVI', 'profile', 'plan',
                               'aspect', 'geological', 'rain', 'TRI', 'STI'])
...
exp_1.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_T_ALL_1.csv")
probability_2 = clf.predict_proba(x_2)
exp_2 = DataFrame(probability_2)
exp_2.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_T_ALL_2.csv")
probability_3 = clf.predict_proba(x_3)
exp_3 = DataFrame(probability_3)
exp_3.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_T_ALL_3.csv")
probability_4 = clf.predict_proba(x_4)
exp_4 = DataFrame(probability_4)
exp_4.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_T_ALL_4.csv")
probability_5 = clf.predict_proba(x_5)
exp_5 = DataFrame(probability_5)
exp_5.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_T_ALL_5.csv")