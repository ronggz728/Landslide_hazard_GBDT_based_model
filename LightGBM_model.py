...
exp_1.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_ALL_1.csv")
probability_2 = clf.predict_proba(x_2)
exp_2 = DataFrame(probability_2)
exp_2.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_ALL_2.csv")
probability_3 = clf.predict_proba(x_3)
exp_3 = DataFrame(probability_3)
exp_3.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_ALL_3.csv")
probability_4 = clf.predict_proba(x_4)
exp_4 = DataFrame(probability_4)
exp_4.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_ALL_4.csv")
probability_5 = clf.predict_proba(x_5)
exp_5 = DataFrame(probability_5)
exp_5.to_csv("F://fifth paper//OUTPUT//LGBM//LGBM_ALL_5.csv")